...
format: `V<major:2>.<minor1:2>.<minor2:2>.<flags:1>`

Example: `V07.06.00.0`, `V07.06.00.2`

- major: Two-digit major version.
- minor1: Two-digit minor version.
- minor2: Two-digit patch version.
