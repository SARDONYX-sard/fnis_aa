// SPDX-FileCopyrightText: (C) 2026 Thiago Kaique
// SPDX-License-Identifier: LGPL-2.1-only
//
// - src: https://github.com/QTR-Modding/SKSE-Menu-Framework-3-API/tree/1dcb70179076aae4ab626f43c5baab2735ca5877
//
// This file incorporates code originally licensed under LGPL-2.1.
// The LGPL-2.1-licensed code is used in accordance with the GPL compatibility provisions of LGPL-2.1.
// See: https://www.gnu.org/licenses/license-list.html.en#LGPLv2.1
//
// changed
// - remove deprecated utf8 api
// - format
// - fix strut ImGuiTextFilter
#pragma once
...
#define IM_COL32_BLACK_TRANS IM_COL32(0, 0, 0, 0)    // Transparent black = 0x00000000
    ...
    typedef enum { ImGuiMouseButton_Left = 0,
        ImGuiMouseButton_Right = 1,
        ImGuiMouseButton_Middle = 2,
        ImGuiMouseButton_COUNT = 5 } ImGuiMouseButton_;
    typedef enum {
    ...
    typedef enum { ImGuiLayoutType_Horizontal = 0,
        ImGuiLayoutType_Vertical = 1 } ImGuiLayoutType_;
    typedef enum {
        ImGuiLogType_None = 0,
        ImGuiLogType_TTY,
        ImGuiLogType_File,
    ...
    typedef enum { ImGuiInputSource_None = 0,
        ImGuiInputSource_Mouse,
        ImGuiInputSource_Keyboard,
        ImGuiInputSource_Gamepad,
        ImGuiInputSource_COUNT } ImGuiInputSource;
    ...
    typedef enum { ImGuiNavLayer_Main = 0,
        ImGuiNavLayer_Menu = 1,
        ImGuiNavLayer_COUNT } ImGuiNavLayer;
    struct ImGuiNavItemData {
        ImGuiWindow*           Window;
        ImGuiID                ID;
