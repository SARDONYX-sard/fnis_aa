...
TEST_CASE_METHOD(ValidFixture, "set list sorted by group_id") {
    ...
    CHECK(cfg.set_list[0] == "001001");  // fsm _mt  base=1
    CHECK(cfg.set_list[1] == "011010");  // fs3 _mt  base=10
    CHECK(cfg.set_list[2] == "011101");  // fs3 _mtx base=1
    CHECK(cfg.set_list[3] == "023701");  // xpe _1hmeqp base=1
    CHECK(cfg.set_list[4] == "023901");  // xpe _2hmeqp base=1
}
